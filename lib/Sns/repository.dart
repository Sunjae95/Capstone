...
class Repository {
  ...
  Future<void> addPostToDb(Member currentUser, String imgUrl, String caption, String location) => _firebaseProvider.addPostToDb(currentUser, imgUrl, caption, location);
  
  Future<Member> retrieveUserDetails(User user) => _firebaseProvider.retrieveUserDetails(user);
  ...
  Future<Member> fetchUserDetailsById(String uid) => _firebaseProvider.fetchUserDetailsById(uid);
  ...
  Future<List<Member>> fetchAllUsers(User user) => _firebaseProvider.fetchAllUsers(user);
