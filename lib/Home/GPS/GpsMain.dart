...
class GpsMain extends StatefulWidget {
  @override
  State<GpsMain> createState() => GpsMainState();
}

class GpsMainState extends State<GpsMain> {
  ...
  void initState() {
    ...
    _markers.add(
      Marker(
        ...
        position: LatLng(37.39096, 126.91920),
  ...
  void _submit() {
    ...
    _searchPlaces(foundPlace['placeName'], 37.39096, 126.91920);
            ...
            Container(
              ...
              child: Column(
                children: <Widget>[
                  ...
                  FloatingActionButton.extended(
                    heroTag: 'btn3',
                    label: Text('Pet Tracking'),
                    icon: Icon(Icons.location_searching),
                    elevation: 8,
                    backgroundColor: Colors.greenAccent[400],
                    onPressed: () {
                      setState(() {
                        _markers=mapNotifier.markers;
                      });
